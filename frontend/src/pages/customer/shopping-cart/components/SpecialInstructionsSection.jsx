    ...
    <div className="bg-card border border-border rounded-lg p-4 md:p-6 shadow-warm">
      <div className="flex items-center gap-2 mb-3 md:mb-4">
        ...
        <h3 className="text-lg md:text-xl font-heading font-semibold text-foreground">
          {t("customer.cart.specialInstructions.title", "Special Instructions")}
        </h3>
      </div>

      <p className="text-sm md:text-base text-muted-foreground mb-3 md:mb-4">
        {t("customer.cart.specialInstructions.description", "Add any dietary requirements, allergies, or special requests for the kitchen")}
      </p>

      <textarea
        value={value}
        onChange={handleChange}
        placeholder={t("customer.cart.specialInstructions.placeholder", "E.g., No onions, extra spicy, gluten-free preparation...")}
      ...
      <div className="flex items-center justify-between mt-2">
        <p className="text-xs md:text-sm text-muted-foreground">
          {t("customer.cart.specialInstructions.optional", "Optional - Help us serve you better")}
        </p>
